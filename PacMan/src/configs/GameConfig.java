...
public class GameConfig {
  ...
  public static final int HEIGTH_HEADER=50;
	...
	public static final int PINKY_SPAWN_POINT_X = 1;
	public static final int PINKY_SPAWN_POINT_Y = 1;
	public static final int BLINKY_SPAWN_POINT_X = 25;
	public static final int BLINKY_SPAWN_POINT_Y = 1;
	public static final int INKY_SPAWN_POINT_X = 25;
	public static final int INKY_SPAWN_POINT_Y = 26;
	public static final int CLYDE_SPAWN_POINT_X = 25;
	public static final int CLYDE_SPAWN_POINT_Y = 26;
